...
from sources import CONFIRMED_APPFOLIO_SOURCES, NEIGHBORHOOD_APPFOLIO_SOURCES
...
def build_pools():
    ...
    for src in CONFIRMED_APPFOLIO_SOURCES + NEIGHBORHOOD_APPFOLIO_SOURCES:
...
if __name__ == "__main__":
    ...
    print(f"\nSCORED_POOL: {len(scored)} listings")
    print(f"BONUS_POOL: {len(bonus)} listings")
